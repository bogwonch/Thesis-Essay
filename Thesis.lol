...
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {5.4}An example of a shell code PIP for X86 and MIPS which attempts to spawn a shell and elevate permissions. Shellcode for each architecture was taken from \autocite {Imrigan:vg}\autocite {TheWorm:vp}.}{49}{lstlisting.5.4}
