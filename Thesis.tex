...
\\\noalign{\medskip}
\emph{Random} & 39 (0.0\%) & 0 & 205 (0.2\%) & 0
\LL
}
...
caption=An example of a shellcode PIP for X86 and MIPS which attempts to spawn \textsf{/bin/sh} and elevate permissions.  Shellcode for each architecture was taken from \autocite{Imrigan:vg}\autocite{TheWorm:vp}.]
